...
def build_submission(df, y_pred):
    ...
    df.to_json('submission.json', orient='records', lines=True, force_ascii=False)
...
if __name__ == '__main__':
    ...
    # train_clf(model=model_processor.model, device=DEVICE, dataloader=t_dataloader, epoch=1)
